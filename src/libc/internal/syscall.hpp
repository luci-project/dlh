...
static inline long __syscall0(syscall_t __n) {
	unsigned long __ret;
	asm volatile ("syscall" : "=a"(__ret) : "a"(__n) : "rcx", "r11", "memory");
	return __ret;
}

static inline long __syscall1(syscall_t __n, long __a1) {
	unsigned long __ret;
	asm volatile ("syscall" : "=a"(__ret) : "a"(__n), "D"(__a1) : "rcx", "r11", "memory");
	return __ret;
}

static inline long __syscall2(syscall_t __n, long __a1, long __a2) {
	unsigned long __ret;
	asm volatile ("syscall" : "=a"(__ret) : "a"(__n), "D"(__a1), "S"(__a2) : "rcx", "r11", "memory");
	return __ret;
}

static inline long __syscall3(syscall_t __n, long __a1, long __a2, long __a3) {
	unsigned long __ret;
	asm volatile ("syscall" : "=a"(__ret) : "a"(__n), "D"(__a1), "S"(__a2), "d"(__a3) : "rcx", "r11", "memory");
	return __ret;
}

static inline long __syscall4(syscall_t __n, long __a1, long __a2, long __a3, long __a4) {
	unsigned long __ret;
...
static inline long __syscall5(syscall_t __n, long __a1, long __a2, long __a3, long __a4, long __a5) {
	unsigned long __ret;
	register long __r10 __asm__("r10") = __a4;
...
static inline long __syscall6(syscall_t __n, long __a1, long __a2, long __a3, long __a4, long __a5, long __a6) {
	unsigned long __ret;
	register long __r10 __asm__("r10") = __a4;
	register long __r8 __asm__("r8") = __a5;
